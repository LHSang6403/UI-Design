    ...
    <>
      <Template>
        <main className="min-h-screen-w-full flex flex-col items-center gap-4">
          <div className="mt-2 grid w-full px-64">
          ...
          <div className="content flex w-full flex-col justify-start px-64">
            ...
            <h2 className="mb-0 text-start text-xl font-bold">Delivered to</h2>
            <span className="mb-4 text-start text-lg font-semibold">
              227 Nguyen Van Cu
            </span>
            <h3 className="mb-0 text-start text-xl font-bold">
              Delivery arrival time
            </h3>
            <span className="mb-6 text-start text-lg font-semibold">
              20 mins (3,1 km away)
            </span>
            <div className="form-group">
              ...
              <div className="mb-5 grid w-full items-center gap-1.5">
                <Label className="font-semibold" htmlFor="detailAddress">
                  Detail Address
                </Label>
                <Input
                  type="text"
              ...
              <div className="mb-5 grid w-full items-center gap-1.5">
                <Label className="font-semibold" htmlFor="addressNote">
              ...
              <div className="my-9">
                <h4 className="title text-sm font-semibold">Order Summary</h4>
                <div className="list-food">
                  <div className="item flex items-center py-2">
                    <div className="input-group flex">
                      <Button
                        onClick={dec}
                        className="text-md text-[#F17228] hover:bg-white"
                      >
                        -
                      </Button>
                      <Input
              ...
              <div className="provision mb-8 flex justify-between">
                ...
                <span className="text-sm font-semibold">$3.88</span>
              </div>
              <div className="payment-detail">
                <div className="title text-2xl font-bold">Payment Details</div>

...
export default function Item({
  ...
  return (
    <div>
      ...
      <p className="text-sm text-cyellow flex items-center"><img src="/assets/fooditem/cook.png" alt="" /> {location}</p>
      <div className="flex justify-between">
        ...
        <p className="text-sm flex items-center">
          ...
          <path d="M11 8V13H16" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
        </svg> 20 minutes</p>
      </div>

...
import ShoppingCartDialog from "@components/FoodCart/ShoppingDialog"; // import the ShoppingCartDialog
...
const FoodDialog: React.FC<FoodDialogProps> = ({
  ...
  // State to control the opening of the ShoppingCartDialog
  ...
  return (
    <>
      <Dialog open={isFoodDialogOpen} onOpenChange={setFoodDialogOpen}>
        ...
        <DialogContent className="rounded-md sm:max-w-[500px]">
          ...
          <DialogFooter className="flex flex-row items-center">
            ...
            <OrangeButton className="w-full" onClick={handleAddToBasket}>
              Add to Basket
            </OrangeButton>
          </DialogFooter>
        </DialogContent>

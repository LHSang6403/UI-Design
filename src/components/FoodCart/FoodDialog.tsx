...
const FoodDialog: React.FC<FoodDialogProps> = ({ count, onIncrement, onDecrement }) => {
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="flex flex-row gap-4">
            ...
            <div className="text-start">
              ...
              <p className="description text-slate-400">
                A cheeseburger features a juicy ground beef patty topped with a melted slice of cheese, typically cheddar, American, or Swiss, served in a soft bun
              </p>
            </div>
        ...
        <DialogFooter className="flex flex-row items-center">
          <div className="input-group flex">
            <Button onClick={onDecrement} className="hover:bg-white text-[#F17228]">-</Button>
            <Input
              type="number"
              className="font-semibold w-11 text-center border-transparent focus:border-transparent [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
              value={count}
              readOnly
            />
            <Button onClick={onIncrement} className="hover:bg-white text-[#F17228]">+</Button>
          </div>
